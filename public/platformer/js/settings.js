window.STALE_Settings = {
  data: { master:80, music:60, sfx:90, shake:true, particles:true, timer:true, flash:false, mode:'chill', controls:'auto', pilotName:'', seenIntro:false, unlocked:1, sprinklesTotal:0 },
  load(){
