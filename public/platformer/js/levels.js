// STALE: 20 levels across 4 worlds. L1-3 handcrafted tutorials, L4-19 generated, L20 boss.
...
function genLevel(n){
  ...
  const wdef = n<=7 ? {w:'Countertop',sub:'crumbs & courage',dark:false,soda:false,foes:['crawler']}
    ...
    : {w:'Mold Maze',sub:'the grey closes in',dark:R()<0.5,soda:false,foes:['crawler','bat','gulper','crawler']};
  ...
  // pretzel check-in before the home stretch
  if(n===10||n===15) npcs.push(N('pretzel',W-700,480,'Halfway there, baby! …well, not HALF. You look strong! Full jam, fresh hearts — GO!'));
  return {
