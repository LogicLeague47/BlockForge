...
export const ACHIEVEMENTS = [
  ...
  },
  {
    ...
    icon: BLOCK.CRAFTING,
    category: 'story',
    check: s => [BLOCK.CRAFTING, BLOCK.JUNGLE_CRAFTING, BLOCK.BIRCH_CRAFTING,
      BLOCK.SPRUCE_CRAFTING, BLOCK.DARK_OAK_CRAFTING, BLOCK.ACACIA_CRAFTING]
      .some(id => (s.crafted[`${id}`] || 0) >= 1),
  },
  {
    id: 'time_to_mine',
    name: 'Time to Mine!',
