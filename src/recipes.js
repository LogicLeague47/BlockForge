...
export const RECIPES = [
  ...
  shaped({
    out: { id: B.JUNGLE_CRAFTING, count: 1 },
    pattern: ['PP', 'PP'],
    key: { P: B.JUNGLE_PLANKS },
  }),
  shaped({
    out: { id: B.BIRCH_CRAFTING, count: 1 },
    pattern: ['PP', 'PP'],
    key: { P: B.BIRCH_PLANKS },
  }),
  shaped({
    out: { id: B.SPRUCE_CRAFTING, count: 1 },
    pattern: ['PP', 'PP'],
    key: { P: B.SPRUCE_PLANKS },
  }),
  shaped({
    out: { id: B.DARK_OAK_CRAFTING, count: 1 },
    pattern: ['PP', 'PP'],
    key: { P: B.DARK_OAK_PLANKS },
  }),
  shaped({
    out: { id: B.ACACIA_CRAFTING, count: 1 },
    pattern: ['PP', 'PP'],
    key: { P: B.ACACIA_PLANKS },
  }),
  shaped({
  ...
  shaped({
    ...
    pattern: ['PPP', ' S ', ' S '],
    key: { P: B.JUNGLE_PLANKS, S: I.STICK },
  }),
  shaped({
  ...
  shaped({
    ...
    pattern: ['PPP', ' S ', ' S '],
    key: { P: B.BIRCH_PLANKS, S: I.STICK },
  }),
  shaped({
  ...
  shaped({
    ...
    pattern: ['PPP', ' S ', ' S '],
    key: { P: B.SPRUCE_PLANKS, S: I.STICK },
  }),
  shaped({
  ...
  shaped({
    ...
    pattern: ['PPP', ' S ', ' S '],
    key: { P: B.DARK_OAK_PLANKS, S: I.STICK },
  }),
  shaped({
  ...
  shaped({
    ...
    pattern: ['PPP', ' S ', ' S '],
    key: { P: B.ACACIA_PLANKS, S: I.STICK },
  }),
  shaped({
  ...
  shaped({ out: { id: B.STONE_BRICKS, count: 4 }, pattern: ['SS', 'SS'], key: { S: B.STONE } }),
  shapeless({ out: { id: B.MOSSY_STONE_BRICKS, count: 1 }, ingredients: [B.STONE_BRICKS, B.LEAVES] }),
  shaped({ out: { id: B.CHISELED_STONE_BRICKS, count: 2 }, pattern: ['SS'], key: { S: B.STONE_BRICKS } }),
  shaped({ out: { id: B.BLACKSTONE_BRICKS, count: 4 }, pattern: ['PP', 'PP'], key: { P: B.POLISHED_BLACKSTONE } }),
  shapeless({ out: { id: B.GILDED_BLACKSTONE, count: 1 }, ingredients: [B.POLISHED_BLACKSTONE, I.GOLD_INGOT] }),
  shaped({ out: { id: B.CHISELED_BRIMSTONE_BRICK, count: 2 }, pattern: ['NN'], key: { N: B.NETHER_BRICK } }),
  shaped({ out: { id: B.CHISELED_SANDSTONE, count: 2 }, pattern: ['SS'], key: { S: B.SANDSTONE } }),
  shaped({ out: { id: B.CUT_SANDSTONE, count: 4 }, pattern: ['SS', 'SS'], key: { S: B.SANDSTONE } }),
  shaped({ out: { id: B.QUARTZ_BRICKS, count: 4 }, pattern: ['QQ', 'QQ'], key: { Q: B.QUARTZ_BLOCK } }),
  shaped({ out: { id: B.QUARTZ_PILLAR, count: 2 }, pattern: ['QQ'], key: { Q: B.QUARTZ_BLOCK } }),
  shaped({ out: { id: B.PRISMARINE_BRICKS, count: 4 }, pattern: ['PP', 'PP'], key: { P: B.PRISMARINE } }),
  shaped({ out: { id: B.DARK_PRISMARINE, count: 8 }, pattern: ['PPP', 'PCP', 'PPP'], key: { P: B.PRISMARINE, C: I.COAL } }),
...
export const SMELTING = {
  ...
  [B.NETHER_BRICK]: B.CRACKED_BRIMSTONE_BRICK,
  [B.SANDSTONE]: B.SMOOTH_SANDSTONE,
  [B.STONE_BRICKS]: B.CRACKED_STONE_BRICKS,
  [B.BLACKSTONE_BRICKS]: B.CRACKED_BLACKSTONE_BRICKS,
