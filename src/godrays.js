...
export class GodRayPass {
  ...
  constructor(renderer, scene, camera, sun) {
    ...
    this._sunVec3 = new THREE.Vector3();
    this._sunUV = new THREE.Vector2();
  ...
  _getSunScreenPos() {
    this._sunVec3.copy(this.sun.position);
    this._sunVec3.project(this.camera);
    this._sunUV.set(
      (this._sunVec3.x + 1) * 0.5,
      (this._sunVec3.y + 1) * 0.5,
    );
    return this._sunUV;
  }
